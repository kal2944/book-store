...
> "Book-store" is a website used to store new books. It is a Single Page App (SPA) that allows users to:

- Make simple book storage.
...
- Solo Project
  - [Kalkidan Daniel](https://github.com/kal2944/book-store)
...
```
$ git clone {https://github.com/kal2944/book-store.git}
```
...
Clone this repository to your desired folder:
    ...
    _git clone https://github.com/kal2944/book-store.git
...
Feel free to check the [issues page](https://github.com/kal2944/book-store/issue).
